    ...
    <div className={`min-h-screen transition-colors duration-300 ${
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <motion.div
              ...
              transition={{ duration: 2, repeat: Infinity }}
              className="flex items-center space-x-2 px-4 py-2 bg-green-500/20 rounded-full backdrop-blur-lg border border-white/20"
            >
      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        >
          {tabs.map((tab) => (
            <motion.button
              ...
              className={`flex items-center space-x-3 px-6 py-4 rounded-2xl font-semibold transition-all duration-300 flex-shrink-0 ${
                activeTab === tab.id
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          {/* Chat Area */}
          <div className="lg:col-span-3 rounded-3xl bg-black/20 backdrop-blur-lg border border-white/10 p-8 shadow-2xl">
                ...
                >
                        ...
                        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4 max-w-2xl mx-auto">
                          {[
                            ...
                            <motion.button
                              ...
                              className="p-3 rounded-xl bg-white/10 backdrop-blur-lg border border-white/20 text-sm opacity-80 hover:opacity-100 transition-opacity"
                            >
                              {suggestion}
                            </motion.button>
                          ))}
                    ...
                    {isLoading && (
                      ...
                      >
                        <div className="flex items-start space-x-4 max-w-[85%]">
                          ...
                          <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl rounded-bl-none p-5">
                  ...
                  <div className="flex space-x-4">
                    <input
                      ...
                      className="flex-1 bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl px-6 py-4 focus:outline-none focus:ring-2 focus:ring-purple-500 text-lg placeholder-white/50"
                    />
                    <motion.button
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                    ...
                    <div className="max-w-2xl mx-auto space-y-6">
                      <div className="flex space-x-4">
                        <input
                          ...
                          className="flex-1 bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl px-6 py-4 focus:outline-none focus:ring-2 focus:ring-purple-500"
                        />
                        <motion.button
                          whileHover={{ scale: 1.05 }}
                          whileTap={{ scale: 0.95 }}
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {[
                          ...
                          <motion.button
                            ...
                            className="p-4 rounded-xl bg-white/10 backdrop-blur-lg border border-white/20 text-left hover:bg-white/20 transition-colors"
                          >
                  ...
                  <div className="text-center">
                    ...
                    >
                      {(() => {
                        ...
                        return TabIcon ? <TabIcon className="w-12 h-12 text-white" /> : null;
                      })()}
                    </motion.div>
                    ...
                    <motion.div
                      ...
                      className="mt-8 inline-flex items-center space-x-2 px-6 py-3 rounded-2xl bg-white/10 backdrop-blur-lg border border-white/20"
                    >
          ...
          <motion.div 
            ...
            className="rounded-3xl bg-black/20 backdrop-blur-lg border border-white/10 p-6 shadow-2xl"
          >
